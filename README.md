This script allows to rename a file or directory name. The general idea is that the filenames start with small letter, whereas the directory names start with capital letter.
